...
namespace SocietySaaS.Infrastructure.Migrations
{
    ...
    [Migration("20260917172930_AddBaseEntityColumns")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocietySaaS.Domain.Entities.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SocietySaaS.Domain.Entities.Flat", b =>
                {
                    ...
                    b.HasIndex("TenantId", "FlatNumber");
            ...
            modelBuilder.Entity("SocietySaaS.Domain.Entities.LedgerEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SocietySaaS.Domain.Entities.OtpRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SocietySaaS.Domain.Entities.Receipt", b =>
                {
                    ...
                    b.HasOne("SocietySaaS.Domain.Entities.Payment", null)
                        .WithOne("Receipt")
                        .HasForeignKey("SocietySaaS.Domain.Entities.Receipt", "PaymentId1")
                        .OnDelete(DeleteBehavior.NoAction);
